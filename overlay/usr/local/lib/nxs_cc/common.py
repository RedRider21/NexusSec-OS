...
.nxs-tile {
  background-color: transparent; color: #c8f5ff;
  border: 1px solid #1a3a52; border-radius: 3px;
  padding: 12px; min-width: 110px; min-height: 96px;
}
.nxs-tile:hover { background-color: rgba(0,229,255,0.08); border-color: #00e5ff; }
...
button {
  background-image: none; background-color: #0a1a26; color: #c8f5ff;
  border: 1px solid #1a3a52; border-radius: 2px; padding: 5px 14px;
}
...
entry {
  background-color: #050a14; color: #c8f5ff;
  border: 1px solid #1a3a52; border-radius: 2px; caret-color: #00e5ff; padding: 4px 8px;
}
...
progressbar > trough { background-color: #0a1422; border: 1px solid #1a3a52; min-height: 14px; }
progressbar > trough > progress { background-color: #00e5ff; }
...
notebook tab { background-color: #050a14; color: #5a8a9a; padding: 6px 12px; }
notebook tab:checked { color: #00e5ff; }
switch { background-color: #0a1422; border: 1px solid #1a3a52; }
switch:checked { background-color: #00334a; border-color: #00e5ff; }
switch slider { background-color: #5a8a9a; }
switch:checked slider { background-color: #00e5ff; }
radiobutton, checkbutton { color: #c8f5ff; }
combobox { color: #c8f5ff; }
frame > border { border: 1px solid #1a3a52; }
