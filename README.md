...
- **Arsenale on-demand** — **488 tool curati** su 16 categorie **+ l'intero
...
Il catalogo conta **488 strumenti** distribuiti su 16 categorie (incluse le nuove
...
| N. strumenti | 488 curati + arsenale Kali | ~600 | ~600 | pochi (mirati) | forensic | ~2800 |
...
> **Sul confronto con BlackArch (~2800 tool).** La differenza "2800 contro 488" e'
...
> (**488 tool**). I tool non presenti nei repo Alpine sono forniti on-demand via
...
condizioni d'uso e le versioni derivate sono descritte in
