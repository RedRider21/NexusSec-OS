# Marchi e branding di NexusSec OS
...
- il **nome** «NexusSec» e «NexusSec OS»;
- il **logo** e gli elementi grafici distintivi (marchio figurativo);
...
Il marchio serve a evitare confusione sull'origine: un utente deve poter sapere
...
- **Uso del nome e del logo** in modo da suggerire un'affiliazione, una
  sponsorizzazione o un'approvazione ufficiale (es. redistribuzione commerciale
  col brand «NexusSec», nome di prodotto/servizio, dominio, materiale
  promozionale) richiede l'**autorizzazione scritta** del titolare.
- Sono sempre leciti gli usi **descrittivi e nominativi** in buona fede
  («basato su NexusSec OS», recensioni, articoli, materiale didattico), purché
  non lascino intendere un rapporto ufficiale inesistente.
...
Questo documento descrive la politica sui marchi e non è una consulenza legale;
per accordi vincolanti fa fede un contratto scritto. I pacchetti di terze parti
inclusi nella distribuzione restano soggetti alle rispettive licenze e ai
rispettivi marchi dei relativi titolari.
